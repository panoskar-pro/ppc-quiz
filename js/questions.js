/**
 * ============================================================================
 * PPC & COMPANY TRAINING QUIZ - QUESTION DATABASE
 * ============================================================================
 * 
 * ΠΩΣ ΝΑ ΠΡΟΣΘΕΣΕΤΕ Ή ΝΑ ΑΛΛΑΞΕΤΕ ΕΡΩΤΗΣΕΙΣ:
 * ----------------------------------------------------------------------------
 * Για να προσθέσετε νέα ερώτηση (π.χ. για Invoicing ή Διαδικασίες),
 * απλά αντιγράψτε το παρακάτω μπλοκ και προσθέστε το στη λίστα questions:
 * 
 * {
 *   "id": 109,
 *   "topic": "Invoicing",               // "Invoicing" | "Google Ads" | "Meta Ads"
 *   "level": 1,
 *   "type": "multiple_choice",          // "multiple_choice" ή "true_false"
 *   "category": "Εγκρίσεις & Διαδικασίες", // Υποκατηγορία
 *   "question": "Εδώ γράφετε την ερώτηση;",
 *   "options": [
 *     "Επιλογή A",
 *     "Επιλογή B",
 *     "Επιλογή C",
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": [
        ...
        "When your ad is displayed to a user",
    ...
    },
    {
      ...
      "options": [
        "Only on Google.com",
        "On Google search results and search partner sites",
        "Only on YouTube",
        "Only on Gmail"
      ],
      "correct_answer": 1,
    ...
    },
    {
      ...
      "options": [
        "The percentage of clicks your ads receive",
        "The percentage of impressions your ads receive out of total eligible impressions",
        "The share of conversions from search",
    ...
    },
    {
      ...
      "options": [
        ...
        "People actively researching or comparing products/services like yours",
        "People based on demographics only",
    ...
    },
    {
      ...
      "options": [
        "To block fake clicks",
        "To track actions users take after clicking your ad",
    ...
    },
    {
      ...
      "options": [
        ...
        "A list of users who have previously interacted with your website or app",
    ...
    },
    {
      ...
      "options": [
        "Target CPA focuses on clicks, Target ROAS on impressions",
        "Target CPA optimizes for a cost per conversion, Target ROAS optimizes for revenue per ad spend",
    ...
    },
    {
      ...
      "options": [
        ...
        "Optimization across multiple campaigns as a group",
        "Access to exclusive ad formats",
    ...
    },
    {
      ...
      "options": [
        ...
        "The highest total conversion value (revenue)",
        "The lowest CPC",
        "The highest CTR"
      ],
      "correct_answer": 1,
    ...
    },
    {
      ...
      "options": [
        "Gives all credit to the first click",
        "Gives all credit to the last click",
    ...
    },
    {
      ...
      "options": [
        "Matching competitors' bids",
        "Uploading your customer data to target or exclude those users",
        "A/B testing for audiences",
    ...
    },
    {
      ...
      "options": [
        "A way to track more conversion types",
        "A feature that supplements conversion tags with hashed first-party data for more accurate measurement",
        "An upgrade to Google Analytics",
    ...
    },
    {
      ...
      "options": [
        ...
        "Increase budget while maintaining Target ROAS, then gradually raise ROAS target",
    ...
    },
    {
      ...
      "options": [
        "Double the budget",
        "Improve Quality Score by optimizing ads and landing pages",
        "Add more keywords to get more impressions",
    ...
    },
    {
      ...
      "options": [
        "Check for new competitors and auction insights",
        "Change the campaign objective",
        "Delete all keywords and start over",
    ...
    },
    {
      ...
      "options": [
        "Search only",
        "Performance Max + branded Search campaigns",
        "Display only",
    ...
    },
    {
      ...
      "options": [
        ...
        "Run geo-based experiments (geo-lift tests)",
        "Check Google Ads conversion column only",
    ...
    },
    {
      ...
      "options": [
        "Last-click attribution with purchase conversion only",
        "Data-driven attribution with micro-conversions (demo requests, free trials) and macro-conversion (closed deals)",
        "First-click attribution with page views as conversions",
    ...
    },
    {
      ...
      "options": [
        "Managing ad approvals",
        "Sending data to Google Ads and Google Analytics from your website",
    ...
    },
    {
      ...
      "question": "Ποιο είναι το βασικό στοιχείο που πρέπει να προηγείται της έκδοσης ενός τιμολογίου προς πελάτη;",
      "options": [
        "Εγκεκριμένο Purchase Order (PO) ή επίσημη γραπτή έγκριση budget/SOW",
        "Τηλεφωνική προφορική συμφωνία μόνο",
        "Αποστολή αναφοράς αποτελεσμάτων στο τέλος του έτους",
        "Έγκριση από το λογιστήριο του ανταγωνιστή"
      ],
      "correct_answer": 0,
      "explanation": "Κάθε έκδοση τιμολογίου απαιτεί επίσημο PO ή υπογεγραμμένο SOW/έγκριση προϋπολογισμού ώστε να υπάρχει πλήρης συμβατική κάλυψη."
    },
    {
      "id": 102,
      "topic": "Invoicing",
      ...
      "type": "true_false",
      "category": "VAT & Taxes",
      "question": "Σε ενδοκοινοτικές συναλλαγές (B2B εντός Ε.Ε. με έγκυρο VIES), ο ΦΠΑ χρεώνεται κανονικά με 24%.",
      "options": [
        "True",
        "False"
      ],
      "correct_answer": 1,
      "explanation": "Στις ενδοκοινοτικές παραδόσεις/παροχές υπηρεσιών B2B με έγκυρο ευρωπαϊκό ΑΦΜ (VIES), ισχύει απαλλαγή ΦΠΑ (Reverse Charge)."
    },
    {
      "id": 103,
      "topic": "Invoicing",
      ...
      "question": "Πότε είθισται να ολοκληρώνεται το billing media spend (π.χ. Google/Meta spend) για τον προηγούμενο μήνα;",
      "options": [
        "Τις πρώτες 5 εργάσιμες ημέρες του επόμενου μήνα, μετά το κλείσιμο των επίσημων reports",
        "Μετά από 6 μήνες",
        "Στα μέσα του τρέχοντος μήνα προκαταβολικά χωρίς invoices",
        "Μόνο όταν το ζητήσει ο πελάτης"
      ],
      "correct_answer": 0,
      "explanation": "Το media spend reconciliation γίνεται τις πρώτες εργάσιμες ημέρες του επόμενου μήνα με βάση τα οριστικά invoices των πλατφορμών."
    },
    {
      "id": 104,
      "topic": "Invoicing",
      ...
      "question": "Πότε εκδίδεται Πιστωτικό Τιμολόγιο (Credit Note);",
      "options": [
        "Όταν ακυρώνεται μέρος ή σύνολο συναλλαγής, ή όταν δίνεται έκπτωση εκ των υστέρων",
        "Όταν θέλουμε να αυξήσουμε τη χρέωση του πελάτη",
        "Όταν αλλάζει το password του Google Ads λογαριασμού",
        "Για να αντικαταστήσουμε το μηνιαίο report αποτελεσμάτων"
      ],
      "correct_answer": 0,
      "explanation": "Το πιστωτικό τιμολόγιο εκδίδεται για να μειώσει ή να ακυρώσει προηγούμενο χρεωστικό τιμολόγιο λόγω επιστροφής, έκπτωσης ή διόρθωσης λάθους."
    },
    {
      "id": 105,
      "topic": "Invoicing",
      ...
      "type": "true_false",
      "category": "myDATA",
      "question": "Όλα τα τιμολόγια εσόδων που εκδίδονται στην Ελλάδα πρέπει να διαβιβάζονται στην πλατφόρμα myDATA της ΑΑΔΕ.",
      "options": [
        "True",
        "False"
      ],
      "correct_answer": 0,
      "explanation": "Σύμφωνα με την ελληνική νομοθεσία, όλα τα παραστατικά εσόδων διαβιβάζονται υποχρεωτικά στο myDATA (ΜΑΡΚ)."
    },
    {
      "id": 106,
      "topic": "Invoicing",
      ...
      "options": [
        "Η πληρωμή πρέπει να γίνει εντός 30 ημερών από την ημερομηνία έκδοσης του τιμολογίου",
        "Έκπτωση 30% αν πληρωθεί άμεσα",
        "Το έργο θα διαρκέσει 30 ημέρες",
        "Η χρέωση αφορά μόνο 30 κλικ"
      ],
      "correct_answer": 0,
      "explanation": "Το 'Net 30' ορίζει ότι το πλήρες ποσό είναι απαιτητό εντός 30 ημερολογιακών ημερών από την ημερομηνία τιμολόγησης."
    },
    {
      "id": 107,
      "topic": "Invoicing",
      "level": 1,
      "type": "multiple_choice",
      "category": "Media Spend Reconciliation",
      "question": "Σε περίπτωση που το πραγματικό spend της καμπάνιας υπολείπεται του προϋπολογισθέντος ποσού που προτιμολογήθηκε:",
      "options": [
        "Γίνεται συμψηφισμός στον επόμενο μήνα ή εκδίδεται πιστωτικό τιμολόγιο",
        "Τα χρήματα χάνονται",
        "Αυξάνεται αυτόματα το management fee",
        "Αγνοούμε τη διαφορά"
      ],
      "correct_answer": 0,
      "explanation": "Στο media reconciliation, το αδιάθετο ποσό (underspend) μεταφέρεται στον επόμενο μήνα ή πιστώνεται στον πελάτη."
    },
    {
      "id": 108,
      "topic": "Invoicing",
      ...
      "question": "Πριν την αποστολή τιμολογίου στον πελάτη, είναι απαραίτητος ο έλεγχος των στοιχείων τιμολόγησης (Επωνυμία, ΑΦΜ, ΔΟΥ, Διεύθυνση).",
      "options": [
        "True",
        "False"
      ],
      "correct_answer": 0,
      "explanation": "Ο έλεγχος ορθότητας φορολογικών στοιχείων αποτρέπει λάθη, καθυστερήσεις πληρωμών και ανάγκη ακυρωτικών."
    },
    {
      "id": 201,
      "topic": "Meta Ads",
      ...
      "question": "Ποια είναι η σωστή ιεραρχία στη δομή μιας διαφήμισης στο Meta Ads Manager;",
      "options": [
        "Campaign -> Ad Set -> Ad",
        "Ad Set -> Campaign -> Ad",
        "Ad -> Ad Set -> Campaign",
      ...
      "correct_answer": 0,
      "explanation": "Η ιεραρχία στο Meta Ads είναι: Campaign (Στόχος/Objective) -> Ad Set (Κοινό, Budget, Placement) -> Ad (Δημιουργικό/Copy)."
    },
    {
      "id": 202,
      "topic": "Meta Ads",
      "level": 1,
      "type": "multiple_choice",
      "category": "Pixel & Conversions",
      "question": "Τι είναι το Meta Conversions API (CAPI);",
      "options": [
        "Ένα server-side εργαλείο για την αξιόπιστη αποστολή συμβάντων απευθείας από τον server στο Meta, παρακάμπτοντας ad-blockers και cookie restrictions",
        "Ένα plugin για γραφιστική επεξεργασία εικόνων στο Canva",
        "Εργαλείο δημιουργίας αυτόματων σχολίων στο Instagram",
        "Εφαρμογή πληρωμών της Meta"
      ],
      "correct_answer": 0,
      "explanation": "Το CAPI στέλνει web/offline events απευθείας από τον server στα συστήματα της Meta, εξασφαλίζοντας υψηλότερη ακρίβεια tracking."
    },
    {
      "id": 203,
      "topic": "Meta Ads",
      ...
      "type": "true_false",
      "category": "Budgeting",
      "question": "Το Advantage Campaign Budget (πρώην CBO) διανέμει αυτόματα το budget στα καλύτερα αποδοτικά Ad Sets σε πραγματικό χρόνο.",
      "options": [
        "True",
        "False"
      ],
      "correct_answer": 0,
      "explanation": "Το Advantage Campaign Budget (CBO) βελτιστοποιεί την κατανομή του συνολικού budget της καμπάνιας μεταξύ των Ad Sets."
    },
    {
      "id": 204,
      "topic": "Meta Ads",
      ...
      "type": "multiple_choice",
      "category": "Audiences",
      "question": "Τι είναι ένα 'Lookalike Audience' στο Meta Ads;",
      "options": [
        "Κοινό χρηστών που μοιάζει συμπεριφορικά και δημογραφικά με ένα υπάρχον source κοινό (π.χ. αγοραστές)",
        "Κοινό που ακολουθεί μόνο τους ανταγωνιστές",
        "Κοινό που περιέχει αποκλειστικά υπαλλήλους της εταιρείας",
        "Λίστα με email που απορρίφθηκαν"
      ],
      "correct_answer": 0,
      "explanation": "Τα Lookalike Audiences δημιουργούνται από τον αλγόριθμο της Meta για να εντοπίσουν νέα άτομα με παρόμοια χαρακτηριστικά με τους καλύτερους πελάτες σας."
    },
    {
      "id": 205,
      "topic": "Meta Ads",
      ...
      "type": "true_false",
      "category": "Placements",
      "question": "Το Advantage+ Placements επιτρέπει στο σύστημα της Meta να εμφανίζει διαφημίσεις σε Facebook, Instagram, Messenger και Audience Network.",
      "options": [
        "True",
        "False"
      ],
      "correct_answer": 0,
      "explanation": "Τα Advantage+ Placements εκμεταλλεύονται όλα τα διαθέσιμα placements για να πετύχουν το χαμηλότερο δυνατό κόστος ανά αποτέλεσμα."
    }
  ]
};
