 ...
 * Level 1: Invoicing | Level 2: Google Ads
 */
  ...
  "questions": [
    {
      ...
      "options": [
        "Εγκεκριμένο Purchase Order (PO) ή υπογεγραμμένο SOW/έγκριση budget",
        "Προφορική τηλεφωνική συνεννόηση μόνο",
        "Μηνιαίο report αποτελεσμάτων χωρίς έγκριση",
        "Αίτημα από το λογιστήριο του ανταγωνιστή"
      ],
      "correct_answer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "Έκπτωση 30% για άμεση πληρωμή",
        "Η διάρκεια της σύμβασης είναι 30 ημέρες",
        "Χρέωση για 30 κλικ διαφήμισης"
      ],
      "correct_answer": 0,
      "explanation": "Το 'Net 30' ορίζει ότι η οφειλή πρέπει να εξοφληθεί εντός 30 ημερολογιακών ημερών από την τιμολόγηση."
    },
    {
      "id": 1,
      "level": 2,
